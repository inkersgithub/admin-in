...
(function () {
    ...
    var Toolbar = MediumEditor.Extension.extend({
        ...
        handleBlur: function () {
            ...
            // Delay the call to hideToolbar to handle bug with multiple editors on the pages at once
...
(function () {
    ...
    function createContentEditable(textarea) {
        ...
        // to make a unique-id, ensure that the id is actually unique on the pages
                    ...
                    if (currentSelection) {
                        ...
                        if (commonAncestorContainer.nodeType !== 3 && commonAncestorContainer.textContent.length !== 0 && startContainerParentElement === endContainerParentElement) {
                            ...
                            if (currentEditor === parentElement) {
                                ...
                                // as our reference inside this.elements gets detached from the pages when insertHTML runs.
